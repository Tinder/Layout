...
extension UIView {
    public func constraint(for attribute: NSLayoutConstraint.Attribute? = nil,
        ...
        return NSLayoutConstraint(item: self,
                                  ...
                                  relatedBy: .init(relation: relation),
                                  toItem: superview,
    ...
    public func constraints(is relation: ConstraintRelation = .equal,
    ...
    public func widthConstraint(is relation: ConstraintRelation = .equal,
                                _ constant: CGFloat? = nil) -> NSLayoutConstraint {
        let constant = constant ?? bounds.width
        return width.constraint(is: relation, constant)
    }

    public func heightConstraint(is relation: ConstraintRelation = .equal,
                                 _ constant: CGFloat? = nil) -> NSLayoutConstraint {
        let constant = constant ?? bounds.height
        return height.constraint(is: relation, constant)
    }

    public func sizeConstraints(_ size: CGSize? = nil) -> [NSLayoutConstraint] {
        [
    ...
    public func aspectConstraint(_ ratio: CGFloat) -> NSLayoutConstraint {
        constraint(for: .width, to: .height, of: self, multiplier: ratio)
    }

    public func edgeConstraints(insetBy value: CGFloat) -> [NSLayoutConstraint] {
    ...
    public func edgeConstraints(insetBy insets: UIEdgeInsets = .zero) -> [NSLayoutConstraint] {
        [
    ...
    public func centerConstraints(offsetBy offset: UIOffset = .zero) -> [NSLayoutConstraint] {
        [
    ...
    public func equalConstraints(for attribute: NSLayoutConstraint.Attribute,
                                 to views: [UIView]) -> [NSLayoutConstraint] {
